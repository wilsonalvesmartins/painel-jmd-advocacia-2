...
async function startServer() {
    ...
    while (retries) {
        try {
            ...
            client.release();
            await initializeDb();
            break; // Sai do loop se a conexão e inicialização forem bem-sucedidas
        } catch (err) {
    ...
    // Middleware para logar todos os pedidos recebidos
    ...
    // Inicia o servidor Express para ouvir os pedidos
    app.listen(PORT, () => {
        console.log(`API a ouvir na porta ${PORT}`);
    });
}
